...
#include "BoneControllers/ycExtraAnimNode_SpringBone.h"
#include "GameFramework/WorldSettings.h"
#include "Animation/AnimInstanceProxy.h"
#include "Animation/AnimTrace.h"

/////////////////////////////////////////////////////
// FycExtraAnimNode_SpringBone

FycExtraAnimNode_SpringBone::FycExtraAnimNode_SpringBone()
...
void FycExtraAnimNode_SpringBone::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
...
void FycExtraAnimNode_SpringBone::CacheBones_AnyThread(const FAnimationCacheBonesContext& Context)
{
	DECLARE_SCOPE_HIERARCHICAL_COUNTER_ANIMNODE(CacheBones_AnyThread)
	FAnimNode_SkeletalControlBase::CacheBones_AnyThread(Context);
}

void FycExtraAnimNode_SpringBone::UpdateInternal(const FAnimationUpdateContext& Context)
{
	...
	// Fixed step simulation at 360hz
	FixedTimeStep = (1.f / 360.f) * TimeDilation;
}

void FycExtraAnimNode_SpringBone::GatherDebugData(FNodeDebugData& DebugData)
{
...
void FycExtraAnimNode_SpringBone::EvaluateSkeletalControl_AnyThread(FComponentSpacePoseContext& Output, TArray<FBoneTransform>& OutBoneTransforms)
{
...
bool FycExtraAnimNode_SpringBone::IsValidToEvaluate(const USkeleton* Skeleton, const FBoneContainer& RequiredBones)
{
	return (SpringBone.IsValidToEvaluate(RequiredBones));
}

void FycExtraAnimNode_SpringBone::InitializeBoneReferences(const FBoneContainer& RequiredBones)
{
	DECLARE_SCOPE_HIERARCHICAL_COUNTER_ANIMNODE(InitializeBoneReferences)
	SpringBone.Initialize(RequiredBones);
}

void FycExtraAnimNode_SpringBone::PreUpdate(const UAnimInstance* InAnimInstance)
{
