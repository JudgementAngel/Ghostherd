...
void RegisterAll(FMCPToolRegistry& Registry)
{
	...
	// ================================================================
	MCP_TOOL(Registry, "add_material_expression")
		.Description(TEXT("Add a material expression node to a UMaterial asset's expression graph. "
	...
	// ================================================================
	MCP_TOOL(Registry, "connect_material_expression")
		.Description(TEXT("Connect a material expression's output pin to another expression's input pin "
		...
		.IntArg(TEXT("target_input_index"),
	...
	// ================================================================
	MCP_TOOL(Registry, "set_material_expression_value")
		.Description(TEXT("Set a default value or property on a material expression node by index. "
	...
	// ================================================================
	MCP_TOOL(Registry, "get_material_expressions")
		.Description(TEXT("List every expression node in a UMaterial's graph with its index, class name, "
	...
	// ================================================================
	MCP_TOOL(Registry, "add_texture_sample_expression")
		.Description(TEXT("Convenience tool: add a UMaterialExpressionTextureSample node to a material "
			"with a specific texture asset already assigned. "
			"Returns the new expression's index for use in connect_material_expression."))
		.StringArg(TEXT("material_path"),
			TEXT("Content path of the UMaterial asset"), true)
		.StringArg(TEXT("texture_path"),
	...
	// ================================================================
	MCP_TOOL(Registry, "add_material_parameter_expression")
		.Description(TEXT("Add a scalar, vector, or texture parameter expression to a material. "
	...
	// ================================================================
	MCP_TOOL(Registry, "remove_material_expression")
		.Description(TEXT("Remove a material expression node at the given index. "
	...
	// ================================================================
	MCP_TOOL(Registry, "compile_material")
		.Description(TEXT("Trigger a full recompile of a UMaterial by calling PreEditChange + PostEditChange. "
